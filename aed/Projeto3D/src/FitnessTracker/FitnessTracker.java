...
public interface FitnessTracker extends Serializable{
	 ...
	 * @throws AthleteNotExistException Atleta inexistente. Quando o identificador do atleta nao existe no sistema.
	 */
	AthleteGet athleteData(String idTracker) throws AthleteNotExistException;
	...
	/**
	 * Listagem dos treinos do atleta identificado por idTracker por ordem de insercao
	 * @param idTracker id do atleta
	 * @return lista de treinos por ordem de insercao (nome da atividade, calorias)
	 * @throws AthleteNotExistException Atleta inexistente. Quando o identificador do atleta nao existe no sistema. 
	 * @throws AthleteWithNoTrainingException Atleta sem treinos. Quando o atleta nao realizou nenhum treino.
	 */
	Iterator<Training> listTrainingByChronologicalOrder(String idTracker) throws AthleteNotExistException, AthleteWithNoTrainingException;
	
	/**
	 * Listagem dos treinos do atleta identificado por idTracker por ordem decrescente do total de calorias despendidas
	 * @param idTracker id do atleta
	 * @return lista de treinos por ordem decrescente do total de calorias despendidas (nome da atividade, calorias)
	 * @throws AthleteNotExistException Atleta inexistente. Quando o identificador do atleta nao existe no sistema. 
	 * @throws AthleteWithNoTrainingException Atleta sem treinos. Quando o atleta nao realizou nenhum treino.
	 */
	Iterator<Entry<Integer, List<Training>>> listTrainingByCalories(String idTracker) throws AthleteNotExistException, AthleteWithNoTrainingException;
	 ...
	 * @throws GroupNotExistException Grupo inexistente. Quando o identificador do grupo nao existe no sistema.
	 */
	GroupSet groupData(String idGroup) throws GroupNotExistException;
	 ...
	 */
	Iterator<Entry<Integer, List<GroupGet>>> listWalkers() throws GroupsDoesntExistException;
	 ...
	 * @throws GroupsDoesntExistException Nao existem grupos. Quando o sistema nao tem grupos.
	 */
	Iterator<Entry<Integer, List<GroupGet>>> listWarriors() throws GroupsDoesntExistException;

	/**
	 * Listagem dos atletas de um determinado grupo, ordenados pelas calorias perdidas do maior para
	 * o mais pequeno
	 * @param idGroup id do grupo
	 * @return dados dos atletas (nome,sexo,peso,idade,calorias,passos)
	 * @throws GroupNotExistException Grupo inexistente. Quando o identificador do grupo nao existe no sistema.
	 * @throws GroupDoesntHaveAthletesException Nao existem grupos. Quando o sistema nao tem grupos.
	 */
	Iterator<Entry<String, AthleteGet>> ListGroupAthtele(String idGroup) throws GroupNotExistException, GroupDoesntHaveAthletesException;
