...
class AthleteClass implements AthleteSet,Serializable {
	...
	public AthleteClass(int weight, int height, int age, boolean gender, String name, String idTracker) {
		...
		trainingByCalories = new AVLTreeInvert<Integer, List<Training>>();
	}
	...
	@Override
	public Iterator<Entry<Integer, List<Training>>> ListTrainingByCalories() throws AthleteWithNoTrainingException{
		if(training.isEmpty())
			throw new AthleteWithNoTrainingException();
		return trainingByCalories.iterator();
	}
