...
public class FitnessTrackerClass implements FitnessTracker, Serializable {
	...
	public FitnessTrackerClass() {
		...
		listGroupsSteps = new AVLTreeInvert<Integer, List<GroupGet>>();
		listGroupscalories = new AVLTreeInvert<Integer, List<GroupGet>>();
	}
	...
	@Override
	public AthleteGet athleteData(String idTracker) throws AthleteNotExistException {
		AthleteGet athlete = athletes.find(idTracker);
		if (athlete == null)
			throw new AthleteNotExistException();
		return athlete;
	}
	...
	@Override
	public Iterator<Training> listTrainingByChronologicalOrder(String idTracker)
			throws AthleteNotExistException, AthleteWithNoTrainingException {
		AthleteSet athlete = athletes.find(idTracker);
		if (athlete == null)
			throw new AthleteNotExistException();
	...
	@Override
	public Iterator<Entry<Integer,List<Training>>> listTrainingByCalories(String idTracker) 
			throws AthleteNotExistException, AthleteWithNoTrainingException{
		AthleteSet athlete = athletes.find(idTracker);
		if (athlete == null)
			throw new AthleteNotExistException();
