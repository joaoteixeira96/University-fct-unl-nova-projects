...
class GroupClass implements GroupSet, Serializable {

	private static final long serialVersionUID = 0L;
	private String idGroup;
	private String name;
	private int groupCal;
	private OrderedDictionary<String,AthleteGet> athletes; //String = nome do atleta
	...
	public GroupClass(String idGroup, String name) {
		...
		this.name = name;
		groupCal = 0;
		athletes = new AVLTree<String,AthleteGet>();
		groupSteps = 0;
